        ...
        <div className="bg-white relative flex flex-row h-64 border border-gray-300 text-black">
            ...
            <div className="w-2/3 z-10 pt-16 pr-4 pl-2 flex flex-col">
                ...
                <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-xs font-mono text-gray-700 mt-2">
                    <div>
                        <span className="block text-[8px] text-gray-400 uppercase">ID No.</span>
                        <span className="font-bold">{data.idNumber}</span>
                    </div>
                    <div>
                        <span className="block text-[8px] text-gray-400 uppercase">DOB</span>
                        <span className="font-bold">{data.dob}</span>
                    </div>
                    <div>
                        <span className="block text-[8px] text-gray-400 uppercase">Clearance</span>
                        <span className="font-bold text-red-700 border border-red-200 px-1 bg-red-50">{meta.clearance}</span>
                    </div>
                    <div>
                        <span className="block text-[8px] text-gray-400 uppercase">Sex / Height</span>
            ...
            <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="w-full md:w-1/3 border-l-2 border-gray-300 pl-4">
                    ...
                    <div className="h-32 bg-[url('https://www.transparenttextures.com/patterns/diagmonds-light.png')] border border-gray-300 flex items-center justify-center">
                        <span className="text-[10px] uppercase font-bold text-gray-400 rotate-45">Ad Space</span>
                    </div>
                </div>
            </div>
        </div>
...
const MissionRenderer = ({ data, meta }: Document) => (
    <ScannedDocumentWrapper type="mission" seed={data.operation.length}>
        <div className="font-mono text-gray-800 relative h-full">
            ...
            <div className="mb-8">
                <div className="text-xs uppercase tracking-[0.2em] mb-1 text-gray-500">Department of Defense</div>
                <div className="w-full h-px bg-black mb-1"></div>
                <div className="flex justify-between text-xs text-gray-600 font-bold">
                    <span>COPY {meta.copy}</span>
            ...
            <div className="space-y-6">
                <div className="flex items-start gap-4">
                    <div className="w-24 font-bold uppercase text-sm border-r-2 border-gray-300 pr-2 pt-1 text-right">Operation</div>
                ...
                <div className="flex items-start gap-4">
                    <div className="w-24 font-bold uppercase text-sm border-r-2 border-gray-300 pr-2 pt-1 text-right">Target</div>
                ...
                <div className="flex flex-col md:flex-row gap-6 mt-6">
                    <div className="flex-1">
                        <div className="font-bold uppercase text-sm mb-2 border-b border-gray-300 inline-block">Briefing</div>
                    ...
                    {data.intel_photo && (
                        <div className="w-32 shrink-0">
                            <div className="p-1 bg-white shadow-md rotate-2 border border-gray-200">
                                ...
                                <div className="text-[8px] text-center mt-1 text-red-600 font-bold">FIG 1.A</div>
                            </div>
                        </div>
                    )}
                </div>
                ...
                <div className="mt-8 p-4 bg-gray-100 border-l-4 border-black">
                    <div className="font-bold uppercase text-xs mb-2">Authorized Assets</div>
            ...
            <div className="mt-12 text-center">
                <div className="inline-block border-t border-black pt-2 w-48">
                    <div className="font-script text-2xl text-blue-900 -mt-8 mb-2 ml-4 rotate-[-5deg]">General Ross</div>
                    <div className="text-[10px] uppercase font-bold tracking-wider">Commanding Officer</div>
                </div>
            </div>
        </div>
    </ScannedDocumentWrapper>
            ...
            <div className="border-[2px] border-double border-gray-400 p-2 h-full text-black">
                <div className="border-[1px] border-gray-300 p-8 h-full flex flex-col items-center text-center relative bg-[url('https://www.transparenttextures.com/patterns/cream-paper.png')]">
                    ...
                    <div className="mb-8 relative">
                        ...
                        <div className="relative font-serif text-sm tracking-[0.4em] uppercase font-bold text-gray-500 mb-4 mt-8">Official Credential</div>
                    ...
                    <div className="my-8 w-full">
                        <div className="text-gray-500 italic font-serif mb-4">This document certifies that</div>
                        ...
                        <div className="text-gray-500 italic font-serif mt-2">has successfully completed all requirements</div>
                    </div>
                    ...
                    <div className="mt-auto w-full pt-16 flex justify-between items-end px-4 md:px-12">
                        ...
                        <div className="text-center">
                            ...
                            <div className="w-48 border-t border-gray-400 pt-1 text-xs uppercase tracking-widest text-gray-500">Authorized Signature</div>
                        </div>
                    </div>
